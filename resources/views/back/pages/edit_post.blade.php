...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'pageTitle')
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="post_category">
                            ...
                            @foreach(\App\Models\SubCategory::all() as $category)
                                <option value="{{ $category->id }}" {{ $post->category_id == $category->id ? 'selected' : '' }}>{{ $category->sub_category_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <button type="submi" class="btn btn-primary">Update Post</button>
                </div>
            </div>
        </div>
    </div>
