<footer class="bg-dark mt-5">
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                <a class="d-inline-block mb-4 pb-2" href="index.html">
                    ...
                    <h2 class="text-white">Blog Demo</h2>
                </a>
    ...
    <div class="copyright bg-dark content">&copy; <script>document.write(new Date().getFullYear())</script> Designed &amp; Developed By <a href="#">Blog Demo</a></div>
</footer>